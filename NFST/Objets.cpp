...
Objets::Objets()
{
	...
	_listeObjets.emplace_back("Voile de feu", 2, 100000, "Les brulures vous soignent");
	_listeObjets.emplace_back("Bénédiction", 3, 1000, "Augmente la vie Maximum de 50%");
	_listeObjets.emplace_back("Sceptre de druide", 4, 1000, "20% de chances qu'un soins donne également du bouclier, 10% de chance qu'ajouter du bouclier octroie une protection.");
	_listeObjets.emplace_back("Malediction", 5, 100, "Consomme votre bouclier et reduit votre vie de 10% de votre vie max chaque tour mais augmente vos dégats de 150%");
	_listeObjets.emplace_back("Cape habilete", 6, 10000, "+10% coup habile, 6% de chances que les coups habile fassent 3 fois plus de dégats et 3% de chances qu'elle fassent 4 fois plus de dégats(pas pour les attaques bruts)");
	_listeObjets.emplace_back("Patte de lapin", 7, 100000, "+33% vitesse, l'experience gagné au combat par ce personnage est augmenté de 33%");
	_listeObjets.emplace_back("Beuh", 8, 10000, "-80% vitesse, l'experience gagné par ce personnage est multiplié par 2");
	_listeObjets.emplace_back("Voile miroir", 9, 1000, "+ 6% de chances de deviations, les attaques deviés sont 100% plus puissantes");
	_listeObjets.emplace_back("Marshmallow", 10, 1000, "20% de chances d'absorber une attaque ennemi et de transformer les dégats en bouclier");
	...
	_listeObjets.emplace_back("Colère de Florian ", 20, 1000, "+30 points dans chaque stats");
	_listeObjets.emplace_back("Trinité", 21, 10000, "+75 points dans chaque stats");
	_listeObjets.emplace_back("Debardeur de Nicolas ", 22, 1000, "Attaque l'attaquant pour des dégats de 100% votre niveau,+5% d'attaque");
	_listeObjets.emplace_back(" Jue de pomme", 23, 100, "+5% de vie max");
	_listeObjets.emplace_back("Les chaussetes de FLO", 24, 10000, " Attaque l'attaquant pour des dégats de 100% votre niveau, 1 chance sur 10 000 d'infliger poison lors d'une attaque");
	...
	_listeObjets.emplace_back("Jeu NES", 32, 1000, "Un jeux vidéo Nes, The Legend Of Zelda");
	...
	_tableLoot[10].push_back(_listeObjets[OBJET_HORLOGE]);
	_tableLoot[20].push_back(_listeObjets[OBJET_HORLOGE]);
	_tableLoot[30].push_back(_listeObjets[OBJET_HORLOGE]);
	_tableLoot[40].push_back(_listeObjets[OBJET_HORLOGE]);
	_tableLoot[50].push_back(_listeObjets[OBJET_HORLOGE]);
}
